  ...
  return (
    <div>
      {isDebugMode && (
        <div
          id="toast-default"
          className="flex items-center w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 fixed z-[9999999] bottom-5 left-5"
          role="alert"
        >
          ...
          <button
            type="button"
            className="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-900 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
