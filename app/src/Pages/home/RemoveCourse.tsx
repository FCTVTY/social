...
export default function RemoveCourse({ host, profileid }: HomeProps) {
    ...
    const fetchDetails = async () => {
        try {
            const response = await axios.get(`${getApiDomain()}/RemoveCourse?oid=${profileid}`);
        ...
        <main className="profile-page">
            <div className="rounded-md bg-yellow-50 p-4 m-10">
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <h3 className="text-sm font-medium text-yellow-800">Please wait.. Removing Course</h3>
