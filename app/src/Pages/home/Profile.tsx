        ...
        <main className="profile-page">
            ...
            <div className=" min-h-screen">
                <div className="container mx-auto p-4 lg:max-w-7xl">
                    ...
                    <div
                        className="lg:hidden md:hidden rounded-xl border-2 border-gray-100 bg-white dark:bg-zinc-950 dark:border-zinc-800 mb-4 dark:text-white ">
                    ...
                    <div className="bg-white shadow-md rounded-lg overflow-hidden hidden lg:block md:block">
                        ...
                        <div className="w-full mx-auto">
                            ...
                            <div
                                ...
                                <h1 className="text-center text-gray-800 text-4xl"><span
                                    className="inline-flex">{profile?.first_name} {profile?.last_name}
                                    {profile?.verified && (
                                        <BadgeCheck
                                            className="text-indigo-400 h-5 w-5 ml-2 mt-1"></BadgeCheck>)}
                                        </span></h1>
                    ...
                    <div className="mt-4 lg:flex gap-4">
                        ...
                        <div className="lg:w-1/2 sm:w-full ">
                            <div
                                ...
                                {
                                    profile.posts && profile.posts.filter(post => post.type === "event").length == 0 && (
