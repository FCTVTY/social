...
export default function Create() {
    ...
    return (
        <form className="bg-white shadow rounded-lg mb-6 p-2 ">
    <textarea name="message" placeholder="Type something..." className="w-full rounded-lg p-2 text-sm  border border-transparent appearance-none rounded-tg placeholder-gray-400"></textarea>
    <footer className="flex justify-between mt-2">
        ...
        <Button className="flex items-center" color="slate">Upload</Button>
