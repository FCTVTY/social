                                          ...
                                          <div className="group block flex-shrink-0">
                                              ...
                                              <div className="flex py-4 justify-between">
                                                  <div className="flex space-x-2">
                                                      <div
                                                        className="flex space-x-1 items-center h-6 w-16 bg-gray-200 rounded-full"></div>
                                                      <div
                                                        className="flex space-x-1 items-center h-6 w-16 bg-gray-200 rounded-full"></div>
                                                  </div>
                                              </div>
                                              <div
                                                className="mt-0.5 text-sm text-gray-500 h-4 w-32 bg-gray-200 rounded-full"/>
                                              <div
                                                className="mt-0.5 text-sm text-gray-500 h-4 w-32 bg-gray-200 rounded-full"/>
                                              <div
                                                className="mt-0.5 text-sm text-gray-500 h-4 w-32 bg-gray-200 rounded-full"/>
                                   ...
                                   <><dt className="inline-flex py-2">
                                    ...
                                    {community?.community?.private && (
                                        <>
                                            ...
                                            <dd className="text-sm ">Only community members can see who's in the community and what they post.
