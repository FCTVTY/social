...
export default function Site({ host, channel, roles, setRoles }: HomeProps) {
    ...
    return (
        <>
            {community && roles && (roles.includes("admin") || roles.includes("moderator")) && (
                <div className="container mx-auto p-6 h-auto">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6 mt-6">
                        ...
                        <div className="w-full max-w-xs mx-auto">
                            <label htmlFor="color-dropdown" className="block text-gray-700">Select a Color:</label>
                            <select
                              id="color-dropdown"
                              value={selectedColor}
                            ...
                            {selectedColor && (
                              <div className="mt-4 p-4 text-white"
                                   style={{backgroundColor: `var(--tw-${selectedColor}-500)`}}>
                                  ...
                                  <div
                                    className={`${selectedTColor} ${selectedColor} group flex gap-x-3 rounded-md p-2 text-sm leading-6 mr-[26px]`}>
                                      ...
                                      <span
                                        className="mt-[2px]">Menu Item</span>
                                  </div>
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6 mt-6">
                        ...
                        <div className="mb-4">
                            <p>Your website is currently {community.published ? 'published' : 'unpublished'} and can
                                only be viewed by administrators.</p>
                            <button
