...
var require_emailpassword_shared4 = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/emailpassword-shared4.js"(exports) {
    ...
    var types = require_multifactorauth_shared();
    var constants = require_emailpassword_shared5();
    var validators = require_emailpassword_shared6();
    ...
    function normaliseSignInAndUpFeature(config) {
      ...
      var defaultToSignUp = config.defaultToSignUp !== void 0 ? config.defaultToSignUp : false;
    ...
    var EmailPassword = (
      /** @class */
      function(_super) {
        genericComponentOverrideContext.__extends(EmailPassword2, _super);
            ...
            authReact: function(appInfo) {
              EmailPassword2.instance = new EmailPassword2(
                genericComponentOverrideContext.__assign(
                  ...
                  { appInfo, recipeId: EmailPassword2.RECIPE_ID }
                )
              );
...
var require_emailpassword3 = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/emailpassword.js"(exports) {
    ...
    var recipe = require_emailpassword_shared4();
    require_supertokens_web_js();
    require_cookieHandler();
...
var require_emailpassword4 = __commonJS({
  "node_modules/supertokens-auth-react/recipe/emailpassword/index.js"(exports) {
    ...
    exports.__esModule = true;
    __export(require_emailpassword3());
  }
});
export default require_emailpassword4();
