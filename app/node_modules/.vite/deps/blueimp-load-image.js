...
var require_load_image = __commonJS({
  "node_modules/blueimp-load-image/js/load-image.js"(exports, module) {
    init_shim();
    (function($) {
      "use strict";
      ...
      function loadImage(file, callback, options) {
        function executor(resolve, reject) {
          ...
          var url;
          function resolveWrapper(img2, data) {
            if (resolve === reject) {
              if (resolve) resolve(img2, data);
              return;
            } else if (img2 instanceof Error) {
              reject(img2);
              return;
            }
            data = data || {};
...
var require_load_image_scale = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-scale.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
...
var require_load_image_meta = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-meta.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
...
var require_load_image_fetch = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-fetch.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
...
var require_load_image_exif = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-exif.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
        ...
        factory(require_load_image(), require_load_image_meta());
      } else {
        factory(window.loadImage);
      }
    })(function(loadImage) {
...
var require_load_image_exif_map = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-exif-map.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
        ...
        factory(require_load_image(), require_load_image_exif());
      } else {
        factory(window.loadImage);
      }
    })(function(loadImage) {
...
var require_load_image_iptc = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-iptc.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
      ...
      function combineTagValues(value, newValue) {
        if (value === void 0) return newValue;
      ...
      function parseIptcTags(dataView, segmentOffset, segmentLength, data, includeTags, excludeTags) {
        ...
        while (offset < segmentEnd) {
          if (dataView.getUint8(offset) === 28 && // tag marker
          dataView.getUint8(offset + 1) === 2) {
      ...
      function isSegmentStart(dataView, offset) {
        return dataView.getUint32(offset) === 943868237 && // Photoshop segment start
        dataView.getUint16(offset + 4) === 1028;
      }
        ...
        while (offset + 8 < markerLength) {
          if (isSegmentStart(dataView, offset)) {
            ...
            parseIptcTags(
              ...
              options.excludeIptcTags || { 202: true }
              // ObjectPreviewData
            );
            return;
          }
...
var require_load_image_iptc_map = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-iptc-map.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
        ...
        factory(require_load_image(), require_load_image_iptc());
      } else {
        factory(window.loadImage);
      }
    })(function(loadImage) {
...
var require_load_image_orientation = __commonJS({
  "node_modules/blueimp-load-image/js/load-image-orientation.js"(exports, module) {
    init_shim();
    (function(factory) {
      "use strict";
      if (typeof define === "function" && define.amd) {
        ...
        factory(
          require_load_image(),
          require_load_image_scale(),
          require_load_image_meta()
        );
      } else {
        factory(window.loadImage);
      }
      ...
      loadImage.transform = function(img, options, callback, file, data) {
        originalTransform.call(
          ...
          function(img2, data2) {
            if (data2) {
              var autoOrientation = loadImage.orientation && data2.exif && data2.exif.get("Orientation");
              if (autoOrientation > 4 && autoOrientation < 9) {
                var originalWidth = data2.originalWidth;
                var originalHeight = data2.originalHeight;
                data2.originalWidth = originalHeight;
                data2.originalHeight = originalWidth;
              }
            }
            callback(img2, data2);
          },
...
var require_js = __commonJS({
  "node_modules/blueimp-load-image/js/index.js"(exports, module) {
    init_shim();
    module.exports = require_load_image();
    require_load_image_scale();
    require_load_image_meta();
    require_load_image_fetch();
    require_load_image_exif();
    require_load_image_exif_map();
    require_load_image_iptc();
    require_load_image_iptc_map();
    require_load_image_orientation();
  }
});
export default require_js();
//# sourceMappingURL=blueimp-load-image.js.map
