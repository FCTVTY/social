      ...
      function() {
        function ProcessState2() {
          ...
          this.addState = function(state) {
            try {
              if (import_process.default !== void 0 && import_process.default.env !== void 0 && import_process.default.env.TEST_MODE === "testing") {
            ...
            return __generator(_a, function(_b) {
              switch (_b.label) {
                ...
                case 8:
                  ...
                  if (!(preRequestLSS.status === "EXISTS")) return [3, 10];
                ...
                case 21:
                  ...
                  if (!(postRequestIdToken.status === "NOT_EXISTS")) return [3, 24];
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 11:
              ...
              if (!(isUnauthorised && response.headers.get("front-token") === null)) return [3, 13];
            ...
            case 19:
              ...
              return [4, getLocalSessionState(false)];
            case 20:
              if (!(_b.sent().status === "NOT_EXISTS")) return [3, 23];
...
var require_utils2 = __commonJS({
  "node_modules/supertokens-web-js/lib/build/utils.js"(exports) {
    ...
    function isTest() {
      try {
        return import_process.default.env.TEST_MODE === "testing";
      } catch (err) {
        return false;
      }
    }
            ...
            return __generator(_a, function(_e) {
              switch (_e.label) {
                ...
                case 4:
                  ...
                  _e.label = 5;
                case 5:
                  if (false) return [3, 39];
                  return [4, (0, fetch_1.getLocalSessionState)(true)];
                case 6:
                  preRequestLSS = _e.sent();
                  configWithAntiCsrf = config;
                  if (!(preRequestLSS.status === "EXISTS")) return [3, 8];
                  return [4, fetch_1.AntiCsrfToken.getToken(preRequestLSS.lastAccessTokenUpdate)];
                case 7:
                ...
                case 10:
                  ...
                  if (!(localPrevResponse === void 0)) return [3, 12];
                  return [4, httpCall(configWithAntiCsrf)];
                case 11:
                  _b = _e.sent();
                  return [3, 13];
                ...
                case 15:
                  ...
                  (0, logger_1.logDebugMessage)("doRequest: Not retrying original request");
                  if (!refreshResult.error) return [3, 17];
                ...
                case 25:
                  ...
                  if (!(response !== void 0)) return [3, 36];
                  return [4, saveTokensFromHeaders(response)];
                case 26:
                  _e.sent();
                  (0, fetch_1.fireSessionUpdateEventsIfNecessary)(preRequestLSS.status === "EXISTS", response.status, response.headers["front-token"]);
                ...
                case 27:
                  refreshResult = _e.sent();
                  if (!(refreshResult.result !== "RETRY")) return [3, 31];
                  (0, logger_1.logDebugMessage)("doRequest: Not retrying original request");
                  if (!(refreshResult.error !== void 0)) return [3, 29];
                  return [4, (0, axiosError_1.createAxiosErrorFromFetchResp)(refreshResult.error)];
                case 28:
                  _d = _e.sent();
                  return [3, 30];
                ...
                case 41:
                  ...
                  if (!(postRequestIdToken.status === "NOT_EXISTS")) return [3, 44];
                  (0, logger_1.logDebugMessage)("doRequest: local session doesn't exist, so removing anti-csrf and sFrontToken");
                  return [4, fetch_1.AntiCsrfToken.removeToken()];
                case 42:
                  _e.sent();
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                ...
                case 4:
                  return [2, _a.sent()];
                case 5:
                  if (!(status_1 === fetch_1.default.config.invalidClaimStatusCode)) return [3, 7];
                  return [
                    4,
                ...
                case 8:
                  ...
                  return [4, (0, fetch_1.getLocalSessionState)(false)];
                case 9:
                  if (!!(_a.sent().status === "EXISTS")) return [3, 12];
                ...
                case 14:
                  ...
                  if (!(err_1.status !== void 0)) return [3, 16];
...
//# sourceMappingURL=chunk-5WMDPTXS.js.map
