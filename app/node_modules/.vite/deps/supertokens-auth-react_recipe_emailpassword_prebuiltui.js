...
import {
  ...
  require_session as require_session2,
  ...
  "node_modules/supertokens-auth-react/lib/build/multifactorauth.js"(exports) {
    ...
    var Wrapper = (
      ...
      function() {
        ...
        Wrapper2.redirectToFactor = function(factorId, forceSetup, redirectBack, navigate, userContext) {
        ...
        Wrapper2.redirectToFactorChooser = function(redirectBack, nextFactorOptions, navigate, userContext) {
          if (redirectBack === void 0) {
            redirectBack = true;
          }
  ...
  "node_modules/supertokens-auth-react/lib/build/emailpassword-shared5.js"(exports) {
    ...
    var FormBase = function(props) {
      ...
      var onFormSubmit = React.useCallback(
        function(e) {
          return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function() {
            var apiFields, fieldUpdates, result, generalError, fetchError, e_1, _loop_1, _i, formFields_1, field, errorFields_1, getErrorMessage_1;
            ...
            isVerified: function(refetchTimeOnFalseInSeconds, maxAgeInSeconds) {
              return {
                ...
                shouldRefresh: function(payload, userContext) {
                  ...
                  maxAgeInSeconds = maxAgeInSeconds !== null && maxAgeInSeconds !== void 0 ? maxAgeInSeconds : getThresholdAwareDefaultValue(300);
                  ...
                  return value === void 0 || _this.getLastFetchedTime(payload, userContext) < DateProvider.now() - maxAgeInSeconds * 1e3 || value === false && _this.getLastFetchedTime(payload, userContext) < DateProvider.now() - refetchTimeOnFalseInSeconds * 1e3;
                },
                ...
                genericComponentOverrideContext.__assign({}, validator.apply(void 0, args)),
                {
                  onFailureRedirection: function(args2) {
                    ...
                    if (recipe.config.mode === "REQUIRED") {
                      return recipe.getRedirectUrl({ action: "VERIFY_EMAIL" }, args2.userContext);
                    }
                    return void 0;
                  },
...
var require_emailpasswordprebuiltui = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/emailpasswordprebuiltui.js"(exports) {
    ...
    var formBase = require_emailpassword_shared5();
    var STGeneralError = require_error2();
    var button = require_emailpassword_shared();
    ...
    var constants = require_emailpassword_shared4();
    var recipe$1 = require_emailpassword_shared3();
    require_supertokens_web_js();
    require_cookieHandler();
    require_postSuperTokensInitCallbacks2();
    require_windowHandler();
    ...
    function useChildProps$1(recipe$12, error, onError, clearError, userContext, navigate) {
      var _this = this;
      var session$1 = uiEntry.useSessionContext();
      var recipeImplementation = React.useMemo(
        function() {
          return getModifiedRecipeImplementation$1(recipe$12.webJSRecipe);
        },
        [recipe$12]
      );
      ...
      var onSignInSuccess = React.useCallback(
        ...
        [recipe$12, userContext, navigate]
      );
      return React.useMemo(
        function() {
          var onForgotPasswordClick = function() {
            return recipe$12.redirect({ action: "RESET_PASSWORD" }, navigate, void 0, userContext);
          };
    ...
    function useChildProps(recipe$12, error, onError, clearError, userContext, navigate) {
      var _this = this;
      var session$1 = uiEntry.useSessionContext();
      var recipeImplementation = React.useMemo(
        function() {
