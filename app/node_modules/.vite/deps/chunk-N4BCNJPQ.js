...
} from "./chunk-KMJXUHAY.js";
import {
  require_jsx_runtime
} from "./chunk-ETXTTKGP.js";
import {
  require_react_dom
} from "./chunk-NMH3X5KV.js";
import {
  require_build,
  require_normalisedURLPath,
  require_sessionClaimValidatorStore,
  require_utils
} from "./chunk-5WMDPTXS.js";
import {
  require_react
...
var require_index2 = __commonJS({
  "node_modules/supertokens-auth-react/lib/build/index2.js"(exports) {
    ...
    var ThemeBase$1 = function(_a2) {
      var children = _a2.children, userStyles = _a2.userStyles, loadDefaultFont = _a2.loadDefaultFont;
    ...
    var AuthPageHeader = withOverride("AuthPageHeader", function AuthPageHeader2(_a2) {
      var onSignInUpSwitcherClick = _a2.onSignInUpSwitcherClick, hasSeparateSignUpView = _a2.hasSeparateSignUpView, isSignUp = _a2.isSignUp, showBackButton = _a2.showBackButton, resetFactorList = _a2.resetFactorList;
      var t = translationContext.useTranslation();
      return jsxRuntime.jsxs(React.Fragment, {
        children: [
          jsxRuntime.jsxs(
            ...
            genericComponentOverrideContext.__assign(
              { "data-supertokens": "headerTitle withBackButton" },
              {
                children: [
                  ...
                  !hasSeparateSignUpView ? t("AUTH_PAGE_HEADER_TITLE_SIGN_IN_AND_UP") : isSignUp ? t("AUTH_PAGE_HEADER_TITLE_SIGN_UP") : t("AUTH_PAGE_HEADER_TITLE_SIGN_IN"),
                  jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })
                ]
              }
            )
          ),
          hasSeparateSignUpView && (!isSignUp ? jsxRuntime.jsxs(
            "div",
            genericComponentOverrideContext.__assign(
    ...
    var AuthPageInner = function(props) {
      ...
      var _g = React.useState(errorFromQS), error = _g[0], setError = _g[1];
      var _h = React.useState(false), sessionLoadedAndNotRedirecting = _h[0], setSessionLoadedAndNotRedirecting = _h[1];
      var st = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow();
      var _j = React.useState(props.factors), factorList = _j[0], setFactorList = _j[1];
      var _k = React.useState(
        (_e = (_d = props.isSignUp) !== null && _d !== void 0 ? _d : isSignUpFromQS) !== null && _e !== void 0 ? _e : st.defaultToSignUp
      ), isSignUp = _k[0], setIsSignUp = _k[1];
      var _l = React.useState(0), rebuildReqCount = _l[0], setRebuildReqCount = _l[1];
      ...
      var _m = React.useState(), authComponentListInfo = _m[0], setAuthComponentListInfo = _m[1];
      ...
      var childProps = authComponentListInfo !== void 0 ? genericComponentOverrideContext.__assign(
    ...
    function buildAndSetChildProps(recipeRouters, loadedDynamicLoginMethods, userContext, factorListState, isSignUpState, setComponentListInfo, abort) {
      var _a2, _b, _c, _d;
      return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function() {
        var authRecipesInited, firstFactors, missingPreBuiltUIs, thirdPartyPreBuiltUI, hasSeparateSignUpView, isSignUp, authComps, _i, recipeRouters_1, ui, _e, authComps_1, a, preloadRes, partialAuthComps, selectedComponents;
        return genericComponentOverrideContext.__generator(this, function(_f) {
          switch (_f.label) {
            case 0:
              ...
              if (factorListState === void 0 && (loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0 ? void 0 : loadedDynamicLoginMethods.firstFactors) === void 0 && ((_d = recipe.MultiFactorAuth.getInstance()) === null || _d === void 0 ? void 0 : _d.config.firstFactors) === void 0) {
              ...
              hasSeparateSignUpView = recipeRouters.some(function(ui2) {
                return ui2.requiresSignUpPage && ui2.recipeInstance.firstFactorIds.some(function(id) {
              ...
              _f.label = 1;
            case 1:
              if (!(_e < authComps_1.length)) return [3, 4];
              a = authComps_1[_e];
              if (!(a.type === "FULL_PAGE")) return [3, 3];
              return [4, a.preloadInfoAndRunChecks(firstFactors, userContext)];
            case 2:
              preloadRes = _f.sent();
              if (abort.aborted) {
                return [
            ...
            case 4:
              ...
              partialAuthComps = authComps.filter(function(c) {
                return c.type !== "FULL_PAGE" && c.factorIds.every(function(id) {
                  return firstFactors.includes(id);
                });
              });
...
//# sourceMappingURL=chunk-N4BCNJPQ.js.map
