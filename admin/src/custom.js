...
var Ombe = function(){
	...
	var handlePWAModal = function (){
		if (!window.matchMedia('(display-mode: standalone)').matches) {
		    setTimeout(function(){
    			jQuery('.dz-pwa-modal').addClass('show').css('display', 'block');
    			jQuery('.modal-backdrop').addClass('fade show');
    		}, 3000);
    		jQuery('.modal-backdrop, .pwa-close, .pwa-btn').on('click',function(){
    			jQuery('.dz-pwa-modal').slideDown(500, function() {
	...
	// Progressive Web App Modal ============
	var handleDZPWAModal = function (){
		if (!window.matchMedia('(display-mode: standalone)').matches) {
		    setTimeout(function(){
    			jQuery('.dz-pwa-modal').addClass('show');
    			jQuery('.dz-pwa-modal').addClass('fade show');
    		}, 3000);
    		jQuery('.pwa-backdrop, .pwa-close, .pwa-btn').on('click',function(){
    			jQuery('.dz-pwa-modal').slideUp(500, function() {
	...
	var handleDZNavFloting = function(){

		$(document).on('click', '.dz-floating-toggler', function() {
			$("body").addClass("floating-body");
			$(".dz-nav-floting").addClass("show");
		});	

		$(document).on('click', '.floating-close,.dz-nav-floting.show', function() {
			$(".dz-nav-floting").removeClass("show");
		});
	}
