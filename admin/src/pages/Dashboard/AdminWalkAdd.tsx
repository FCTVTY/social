...
export const AdminWalkAdd: FC = () => {
  ...
  const handleFormSubmit = async (e: FormEvent) => {
    e.preventDefault();
    try {
      const result = await axios.post(`${getApiDomain()}/v1/admin/community`, newCommunity);
      setMessage(true);
      ...
      <div className="container mx-auto px-4 py-6">
        <form onSubmit={handleFormSubmit} className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mb-4">
              <label htmlFor="logo" className="block text-sm font-medium">Image</label>
            ...
            <div className="mb-4">
              <label htmlFor="desc" className="block text-sm font-medium">Details</label>
              <textarea
                  id="desc"
                  name="desc"
                  rows={3}
