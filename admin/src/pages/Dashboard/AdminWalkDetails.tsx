  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const channelResponse = await axios.get<Channel[]>(`${getApiDomain()}/v1/admin/channel?oid=${ID}`);
        ...
        {community && (
            <div className="container mx-auto p-4 sm:p-6 lg:p-8">
              ...
              <div className="mt-6 bg-white shadow rounded-lg">
                <div className="p-6">
                  <h4 className="text-lg font-medium text-gray-900">Channels</h4>
                  <div className="mt-4 overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                      <tr>
                        <th className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Channel Name</th>
