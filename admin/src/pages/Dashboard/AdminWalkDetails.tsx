            ...
            <div className="my-3 px-3">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-400">{community.name}</p>
                 <a href={`http://${url}.app.bhivecommunity.co.uk`}
                       className="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold pt-10  shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 text-white"
                    >
                     visit Community
                    </a>
              </div>
