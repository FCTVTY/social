  ...
  return (
    <nav className="bg-white dark:bg-zinc-950 flex h-[56px] items-center gap-x-2 border-b border-b-border">
      ...
      <div className="flex items-center gap-x-2">
        <div
          className="flex items-center gap-2 rounded-full border border-dashed border-zinc-300 py-px pl-1 pr-3 text-xs/6 font-medium text-zinc-900 dark:border-white/20 dark:text-white">
          <div
            className="flex h-5 w-5 items-center justify-center rounded-full bg-zinc-100 ring-1 ring-zinc-200 dark:bg-zinc-800 dark:ring-white/25">
            <svg viewBox="0 0 8 12" fill="none" className="w-2 fill-zinc-900 dark:fill-white">
              <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M2 3.5C2 2.39543 2.89543 1.5 4 1.5C5.10457 1.5 6 2.39543 6 3.5V4C6 4.27614 5.77614 4.5 5.5 4.5H2.5C2.22386 4.5 2 4.27614 2 4V3.5ZM0.761594 4.92943C0.901674 4.81883 1 4.65765 1 4.47917V3.5C1 1.84315 2.34315 0.5 4 0.5C5.65685 0.5 7 1.84315 7 3.5V4.47917C7 4.65765 7.09833 4.81883 7.23841 4.92943C7.70228 5.2957 8 5.86308 8 6.5V9.5C8 10.6046 7.10457 11.5 6 11.5H2C0.895431 11.5 0 10.6046 0 9.5V6.5C0 5.86308 0.297724 5.2957 0.761594 4.92943Z"></path>
            </svg>
          </div>
          Development preview
        </div>
